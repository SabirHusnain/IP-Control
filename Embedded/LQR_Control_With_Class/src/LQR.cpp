...
void LQR::configLQR(int max_Motor_Voltage, int pin_Pwm, int pwm_Channel, int pwm_Resolution, int pwm_Frequency, int enc_1, int enc_2, int pin_Clockwise, int pin_Anti_Clockwise, float *K)
{
...
void LQR::runLQR()
{
   ...
   ledcWrite(this->pin_Pwm, this->myPwm);
}